package com.llyycci.void_power.client.renderer.hud;
...
import com.llyycci.void_power.client.screen_cache.ScreenCacheImpl;
...
public class VRGlassesHUDRenderer {
    ...
    static final ResourceLocation no_signal = new ResourceLocation(VoidPowerMod.ID, "textures/gui/hud/vr_glasses_no_signal.png");
