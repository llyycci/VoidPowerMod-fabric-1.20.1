...
import static com.llyycci.void_power.utils.ByteUtils.compress;
import static com.llyycci.void_power.utils.ByteUtils.decompress;
...
public class SP_HologramUpdate_B {
	...
	public static void handler(SP_HologramUpdate_B msg, Supplier<NetworkContext> context){
